...
#
# Created: Wed May 27 14:03:47 2015
...
class Ui_AddPhaseDlg(object):
    def setupUi(self, AddPhaseDlg):
        ...
        AddPhaseDlg.resize(714, 382)
        self.buttonBox = QtGui.QDialogButtonBox(AddPhaseDlg)
        self.buttonBox.setGeometry(QtCore.QRect(350, 340, 341, 32))
        ...
        self.tableWidget.setGeometry(QtCore.QRect(410, 10, 281, 321))
        self.tableWidget.setMinimumSize(QtCore.QSize(2, 10))
    ...
    def retranslateUi(self, AddPhaseDlg):
        ...
        item.setText(_translate("AddPhaseDlg", "Fe2O3 + FeO", None))
        ...
        item.setText(_translate("AddPhaseDlg", "Error", None))
